// Generated from antlr/HTMLParser.g4 by ANTLR 4.13.1
package org.itmo.fuzzing.lect9.parser;
...
public class HTMLParser extends Parser {
	...
	public static final int
		RULE_start = 0, RULE_htmlDocument = 1, RULE_scriptletOrSeaWs = 2, RULE_htmlElements = 3, 
		RULE_htmlElement = 4, RULE_htmlContent = 5, RULE_htmlAttribute = 6, RULE_htmlChardata = 7, 
		RULE_htmlMisc = 8, RULE_htmlComment = 9, RULE_script = 10, RULE_style = 11;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "htmlDocument", "scriptletOrSeaWs", "htmlElements", "htmlElement", 
